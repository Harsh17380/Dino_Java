...
public class MainCharacter {
	...
	public MainCharacter() {
		...
		normalRunAnim.addFrame(Resource.getResouceImage("data/character1.png"));
		normalRunAnim.addFrame(Resource.getResouceImage("data/character2.png"));
		jumping = Resource.getResouceImage("data/character3.png");
		downRunAnim = new Animation(90);
		downRunAnim.addFrame(Resource.getResouceImage("data/character5.png"));
		downRunAnim.addFrame(Resource.getResouceImage("data/character6.png"));
		deathImage = Resource.getResouceImage("data/character4.png");
